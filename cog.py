...
from ballsdex.core.models import AchievementRequiredBall
from ballsdex.core.models import PlayerAchievement
from ballsdex.core.models import Achievement as AchievementModel
...
class Achievement(commands.GroupCog):
    ...
    async def list(self, interaction: discord.Interaction):
        ...
        """
        achievement = await AchievementModel.all()
    ...
    async def claim(
        ...
        print(f"--- Debugging Claim for User: {interaction.user.id} ---")
        print(f"Attempting to claim Achievement: {achievement.name} (ID: {achievement.id})")
